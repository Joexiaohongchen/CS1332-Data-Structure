...
public class HromiakAVLTests {
    ...
    public void updateAddNoRotation() {
        ...
        assertEquals("B", strAVL.getRoot().getLeft().getData());
        assertEquals(1, strAVL.getRoot().getLeft()
                .getHeight());
        assertEquals(0, strAVL.getRoot().getLeft()
                .getBalanceFactor());
    }
    ...
    public void removeFullRoot() {
        ...
        //assertEquals(null, strAVL.getRoot().getLeft().getRight().getData());
        //assertEquals(-1, strAVL.getRoot().getLeft().getRight().getBalanceFactor());
        //assertEquals(-1, strAVL.getRoot().getLeft().getRight().getHeight());
        ...
        assertEquals("E", strAVL.getRoot().getRight().getLeft().getData());
        assertEquals(0, strAVL.getRoot().getRight().getLeft().getBalanceFactor());
        assertEquals(0, strAVL.getRoot().getRight().getLeft().getHeight());

        assertEquals("G", strAVL.getRoot().getRight().getRight().getData());
        assertEquals(0, strAVL.getRoot().getRight().getRight().getBalanceFactor());
        assertEquals(0, strAVL.getRoot().getRight().getRight().getHeight());
