...
public class AVLStudentTests {
    ...
    public void testSuccessor() {
        ...
        avlTree.add(40);
        avlTree.add(81);
        assertEquals((Integer) 76, avlTree.getRoot().getData());
        assertEquals((Integer) 90, avlTree.getRoot().getRight().getData());
        assertEquals((Integer) 34, avlTree.getRoot().getLeft().getData());
